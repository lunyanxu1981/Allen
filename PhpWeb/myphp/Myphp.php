...
class Myphp
{
    ...
    public function route()
    {
        ...
        if (!class_exists($controller)) {
            header("Location: /Custom404.html");
            return;
        ...
        $method = new ReflectionMethod($dispatch, $actionName); 
        $trash = array("\n", "/", "*");    
        $doc= json_decode(str_replace($trash,'',$method->getDocComment()));
        exit(json_encode($doc)) ;
