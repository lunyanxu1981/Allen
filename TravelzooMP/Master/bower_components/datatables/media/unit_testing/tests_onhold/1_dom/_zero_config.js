...
$(document).ready( function () {
	...
	oTest.fnTest( 
		"Attempting to page advisory beyond the first page",
		function () { $('#example_previous').click(); },
		function () { return $('#example tbody td:eq(1)').html() == "All others"; }
	);
	...
	oTest.fnTest(
		"Information advisory on first page",
		function () {
	...
	oTest.fnTest(
		"Information advisory to 10 records",
		function () {
			$('#example_previous').click();
	...
	oTest.fnTest(
		"Information with filter 'Win' advisory to first page",
		function () {
			$('#example_previous').click();
			$('#example_previous').click();
			$('#example_previous').click();
	...
	oTest.fnTest(
		"Filter advisory to blank and 1st column sorting",
		function () {
