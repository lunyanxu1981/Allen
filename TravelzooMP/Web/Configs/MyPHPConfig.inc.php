 ...
 * +------------------------------------------------------------------------------
 */
ini_set('session.name', 'PHPSESSID_DEVTZ');
define ( 'MY_ROOT_DOMAIN', 'm-int.cn' );
define ( 'MY_APP_DOMAIN', 'devtravelzoo.m-int.cn' );
define ( 'MY_VAN_DOMAIN', 'devtravelzoo.m-int.cn' );
define ( 'MY_FRONT_DOMAIN', 'devtravelzoo.m-int.cn' );

//小程序配置
define( "WXAPP_APP_ID" , 'wx7949b23c7b450278' );
define( "WXAPP_APP_SECRET" , '67ddef7e6b71efcf9dc09cc747538deb' );
define( "WXAPP_MEM_SUFFIX", 'travelzootest');
define( "WXAPP_PRE_GROUP", 'Tsk82wK0C2ZJcMleqPixS5VzPKpurAPQZhEagFmZ1z4');
define( "WXAPP_GROUP_SUCCESS", 'qKHmR-nYCx55Gx1gPrrXW1irtBHlPmxWvwXuFsij4yI');
define( "WXAPP_GROUP_FAIL", 'XATjMP3FdCsmzk4T-jKXYAOhvmRkfFWXkwNivLiPjDg');
define( "WXAPP_GROUP_WIN", 'yWzjRLyIj4geXvWe02v_L_dgu8q8JLHFy09GxllGbm0');

//TravelZoo配置
define("TZOO_BASE_URL",'https://beta.ssl.localws.travelzoo.com/affiliate/AffiliateAPIService.svc');
define("TZOO_SOAP_URL",'https://beta.ssl.localws.travelzoo.com/affiliate/AffiliateAPIService.svc/soap');
define("TZOO_API_VERSION",'1.0');
define("TZOO_API_KEY",'1cdc7927-7f88-4e9b-af6f-2fe64444423b');
define("TZOO_API_AFFILIATEID",'1218');
define("TZOO_AFFILIATEID",'1218');

//云片短信key
define( "YUN_SMS_KEY" , 'b0415fa821ac3474f8900eb07c2fe188' );
